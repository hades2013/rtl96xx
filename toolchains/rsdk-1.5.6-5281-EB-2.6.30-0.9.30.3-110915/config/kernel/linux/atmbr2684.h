...
/*linux-2.6.19*/ 
#define BR2684_ENCAPS_VC_IP	(3)	/* VC-mux */
#define BR2684_ENCAPS_LLC_IP	(4)
#define BR2684_ENCAPS_AUTODETECT_IP (5)	/* Unsuported */
...
struct atm_backend_br2684 {
	...
	/*linux-2.6.19*/ 
	/*patch from linux 2.4*/
	int	brpppoe;   // Added by Mason Yu for PPPoE PassThrough
//#ifdef CONFIG_EXT_SWITCH
