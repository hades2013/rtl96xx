...
<tr>
	<td width=100% class=greybluebg>System Log</td>
</tr>
<tr>
	<td class=bggrey>
...
<p>
<input type=button value=" Export " onclick=onclick=preDownload()>
<input type=button value=" Clear " onclick=preClear()>
<input type=button value=" Refresh " onclick=refresh(cPage)></td>
</p>
