...
var dev_status_value = new Array(<% CGI_SYS_CATVINFO(); %>);
...
var INPUT_LASER_POWER_INDEX = 2;
var OUTPUT_LEVEL_VAL_INDEX = 3;
//var TEMPER_INDEX_INDEX = 4;
var POWER_12V_INDEX = 5;
var INPUT_LASER_POWER_MW_INDEX = 6;
...
var input_laser_power_mw_val = get_value(INPUT_LASER_POWER_MW_INDEX);
...
*/
	diffCfg("sample", "update", f.sample.value);
	//diffCfg("output_level_atten", "output_level_atten", f.output_level_atten.value);
	subForm(f,'goform/command','CATVINFO', 'dev_status.asp');
}
...
-->
<tr>
	<td class=bgblue>输入光功率 (单位:mW)</td>
	<td class=bggrey>
		<label maxlength="15" name="soft_version" size="15">
		<script language="JavaScript">
		document.write(input_laser_power_mw_val);
		</script>
		</label>
	</td>
</tr> 
...
<tr>
	<td class=bgblue>输出电平 (单位:dBμV)</td>
	<td class=bggrey>
