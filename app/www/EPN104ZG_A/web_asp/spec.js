...
//var str_copyright = 'Copyright (c) 2013 LEPEI Technology Corp.';
//var PROD_MODEL = 'ONU';
//var logo_name = '';
...
function showlogo(PROD_MODEL)
{
	...
	//str+=logo_name;
	str+="images/logo_"+PROD_MODEL+".gif";/*logo_EPN104ZG_A.gif*/
	str+="></td></tr>";
	str+="</table>";
	return str;
}
