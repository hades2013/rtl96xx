...
var syssnmp = new Array('0;80001f88803cd4279aFFFFFFFF;1500;HanZhou China;R&D Hangzhou, Hangzhou LOSO Technologies Co., Ltd.;3;192.168.0.10;1;public;1;;0;;0;;0');//4个团体
*/
...
select:			      	      √   	7
*/
	var snmpv1_id = document.getElementById("SNMPV1");
	var snmpv2c_id = document.getElementById("SNMPV2c");
	var snmpv3_id = document.getElementById("SNMPV3");
	var snmpall_id = document.getElementById("ALL");
	
	if(0 == version)
	{
		snmpv1_id.checked = false;
		snmpv2c_id.checked = false;
		snmpv3_id.checked = false ;
		snmpall_id.checked = false;
	}
	else if(1 == version)
	{
		snmpv1_id.checked = true;
		snmpv2c_id.checked = false;
		snmpv3_id.checked = false ;
		snmpall_id.checked = false;
	}
...
{	
	...
	var sum = 0;
	var v1_val = (snmpv1_id.checked == true?1:0); 
	var v2c_val = (snmpv2c_id.checked == true?3:0);
	var v3_val = (snmpv3_id.checked == true?5:0);
	var all_val = (snmpall_id.checked == true?7:0);
...
function CheckForm()
{
	...
	if((-1 == string.search(reg)) && (-1 == string.search(reg1)))
	{
		alert("信任主机IP地址非法！");
		return false;		
	}
	...
	{	
		...
		{	
			...
			{
				if(-1 != string.indexOf(snmp_comm_name[num])) 
				{
		...
		<table width=100% border=0 align=center cellpadding=5 cellspacing=1
			...
			<tr>
				<td class=bgblue>SNMP版本</td>
 				 <td class=bggrey><input type="checkbox" name="SNMPV1" id="SNMPV1" value="v1" >v1  
								  <input type="checkbox" name="SNMPV2c" id="SNMPV2c" value="v2c">v2c  
								  <input type="checkbox" name="SNMPV3" id="SNMPV3" value="v3">v3 
								  <input type="checkbox" name="ALL" id="ALL" value="all">all </td> 
			</tr>
			<tr>
