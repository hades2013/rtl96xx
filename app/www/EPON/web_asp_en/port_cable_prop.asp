...
function check_all_input()
{
	...
	if (!in_range(f.interval.value, 30, 180)){
		alert("Invalid input for Network Refresh Interval, it should be in range of 30-180s, Please input again");
		return false;	
	}	
	return true;
}
...
<table width=100% border=0 align=center cellpadding=5 cellspacing=1
	class=box_tn>
	<tr>
		<td class=bggrey2 align=center><font size=4>Cable Port</font></td>
	</tr>
	<tr>
		<td>
		<table width=100% border=0 align=center cellpadding=5 cellspacing=1
			bgcolor="#FFFFFF">
			<tr>
				<td class=bgblue>Network Scan Interval</td>
