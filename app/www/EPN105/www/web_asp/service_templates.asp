...
function init()
{
	...
	pageview_add('设备名称', 1, '20%', true, dev_string);
	pageview_add('模板名称', 2, '30%', true, null, "tmpl_edit");
	pageview_add('模板描述', 3, '45%', false);
	pageview_init(tmpl_list, 10, document.getElementById('list_table'), true, checkbox_click, null, '模板列表');
}
</script>
</head>
<body onload="init();">
...
<table width=100% border=0 align=center cellpadding=5 cellspacing=1
	class=box_tn>
	<tr>
		<td class=bggrey2 align=center>启用终端模板</td>
...
<table>
	...
	<td width=30 valign=top>
		<INPUT id = "btn_del" type=button value="删除选择模板"onclick="apply('DELETE');" disabled=true></td>
	<td width=30 valign=top>
		<INPUT type=button value="新建模板" onclick="new_tmpl();"></td>
	</tr>
</table>
</form>
