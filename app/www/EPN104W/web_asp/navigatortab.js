...
var system_syslog = new Array(
	'日志设置','system_log_set.asp',
	'日志信息','system_log.asp')

var wlan_ap = new Array(
	'无线基本设置','wlan_ap_basic.asp',
	'无线安全','wlan_ap_ssid_config.asp',
	'接入控制','wlan_ap_acl.asp',
	'高级设置','wlan_ap_advance.asp',
	'无线用户列表','wlan_ap_client.asp'
	)	
