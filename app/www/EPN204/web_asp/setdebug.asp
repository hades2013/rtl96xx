...
<form name=system_debug action=goform/command method=post>
  ...
  <TABLE cellSpacing=1 cellPadding=2 border=0 width=100%> 
    ...
    <TR class=textCell >
		<TD width="300">MAC 地址(xx:xx:xx:xx:xx:xx)</TD>
		<TD width=30%><input type="text" size="64" id="mac" name="MAC" maxlength="17" ></TD> 
    ...
    <TR class=textCell >
		...
		<TD><input type="text" size="64" id="code" name="MANUCODE" maxlength="64"></TD> 
