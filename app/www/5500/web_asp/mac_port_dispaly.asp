...
var if_search = 0;
var sear_vlan = 0;
var mac_addr_arr=new Array(<% CGI_GET_PORTMAC(); %>);
...
//var firstidx = 1;
//var numMacs = 33;
//var mac_dis_para = new Array(33,1,2);
var mac_dis_para=new Array(<% CGI_GET_PORTMAC_PARA(); %>);
var set_err = 0;
var PortNum = 4;
var portidx = 1;
...
function init()
{
	...
	document.forms[0].num.value = portidx;
...
function ApplyPort()
{
   ...
   diffCfg('portselect', 'portselect', document.portselect.num.value);
   subForm(v,'goform/command','MAC_PORT','mac_port_dispaly.asp');	
}
...
function ApplyPage()
{
   ...
   subForm(v,'goform/command','MAC_PORT_DIS','mac_port_dispaly.asp');	
...
<tr>
  ...
  <TABLE width=100%>
  <TR> <TD colspan=6 class=tb_head>&nbsp;端口选择</TD> </TR>

  <form method="post" name="portselect" action="goform/command"> 
    <TD width=30%><div align="right">
    <SELECT width=40% name=num style="WIDTH:116px" onchange=ApplyPort()>
