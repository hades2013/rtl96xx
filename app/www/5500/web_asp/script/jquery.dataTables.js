...
(function($) {
	...
	$.fn.dataTable = function( oInit )
	{
      ...
      /************* BRCM_FIXUP_ADD ****************/
			this.fnDisplayStartSet = function (val)
			{
        this._iDisplayStart = val;
        this._iDisplayEnd = this._iDisplayStart + this._iDisplayLength;
			};
			this.fnDisplayStartGet = function ()
			{
        return this._iDisplayStart;
			};
			this.fnDisplayLengthSet = function (val)
			{
        this._iDisplayLength = val;
			};
			this.fnDisplayLengthGet = function ()
			{
    ...
    /************* BRCM_FIXUP_ADD ****************/
    this.fnStartChange = function ( start )
    {
      var oSettings = _fnSettingsFromNode( this[_oExt.iApiIndex] );
    ...
    /************* BRCM_FIXUP_ADD ****************/
      ...
      /************* BRCM_FIXUP_COMMENT ****************/
      /************* BRCM_FIXUP_ADD ****************/
			if ( oSettings.oFeatures.bSortOnload )
      /************* BRCM_FIXUP_ADD ****************/
			{
