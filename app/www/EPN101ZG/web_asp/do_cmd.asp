...
//msgs['fail'] = '配置失败!!! 错误代码: ';
msgs['fail'] = '配置失败!';
msgs['reboot'] = '系统正在重启中...请等待计时结束!';
msgs['restore'] = '系统正在恢复出厂设置,请等待计时结束!';
msgs['cfgimport'] = '系统已成功导入配置文件,导入配置文件后会自动重启,请等待计时结束!';
msgs['upgrade'] = '系统软件下载成功,系统正在执行更新,请等待计时结束!';
