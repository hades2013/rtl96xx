...
#define NETSNMP_CONFIGURE_OPTIONS " '--target=mips-linux-uclibc' '--host=mips-linux-uclibc' '--build=i386-redhat-linux' '--prefix=/opt/workspace/rtl9607/product/access/rootfs/../../../app/net-snmp-5.6.2/ipkg-install/' '--disable-nls' '--disable-ipv6' '--enable-mini-agent' '--enable-static' '--with-endianness=little' '--with-logfile=/tmp/log/snmpd.log' '--with-persistent-directory=/tmp/snmp/' '--with-default-snmp-version=2' '--with-sys-contact=root@localhost' '--with-sys-location=Unknown' '--with-enterprise-oid=17409' '--with-enterprise-sysoid=1.3.6.1.4.1.17409.1.15' '--with-enterprise-notification-oid=1.3.6.1.4.17409' '--disable-manuals' '--disable-mib-loading' '--without-libwrap' '--without-rpm' '--with-openssl=internal' '--without-zlib' '--with-out-transports=TCP TCPIPv6 Unix' '--with-transports=Callback UDP ' '--with-out-mib-modules=agent_mibs agentx disman/event disman/schedule hardware host if-mib mibII notification notification-log-mib snmpv3mibs target tcp-mib ucd_snmp udp-mib utilities mibII/ifTable mibII/sysORTable mibII/interfaces if-mib/ifXTable/ifXTable mibII/snmp_mib mibII/vacm_vars mibII/vacm_context ' '--with-mib-modules=mibII/system_mib mibII/vacm_conf snmpv3/usmConf EPN104/miscIdent EPN104/trap EPN104/cltConfigRemoteUpgradeTable EPN104/opRxInputTable EPN104/opRxOutputTable EPN104/dorDCPowerTable product_common/snmp_ipc_interface ' 'build_alias=i386-redhat-linux' 'host_alias=mips-linux-uclibc' 'target_alias=mips-linux-uclibc' 'CC=rsdk-linux-gcc ' 'CFLAGS=-Os -Wall -pipe -mtune=mips32 -funit-at-a-time  -msoft-float -fpic  -I/opt/workspace/rtl9607/product/access/../../app/include -I/opt/workspace/rtl9607/product/access/include -I/opt/workspace/rtl9607/app/shared -Wall ' 'LDFLAGS=-T/opt/workspace/rtl9607/product/access/../../app/rules/shared.lds   -lifm -L/opt/workspace/rtl9607/product/access/lwlib -lshared -L/opt/workspace/rtl9607/app/shared  -lcfg -L/opt/workspace/rtl9607/product/access/lwlib' 'CPPFLAGS= -I/opt/workspace/rtl9607/product/access/../../toolchains/rsdk-1.5.6-5281-EB-2.6.30-0.9.30.3-110915/usr/include  -I/opt/workspace/rtl9607/product/access/../../toolchains/rsdk-1.5.6-5281-EB-2.6.30-0.9.30.3-110915/include -I/opt/workspace/rtl9607/product/access/../../app/include -I/opt/workspace/rtl9607/product/access/include'"

/* default location to look for mibs to load using the above tokens and/or
   those in the MIBS envrionment variable */
#define NETSNMP_DEFAULT_MIBDIRS "$HOME/.snmp/mibs:/opt/workspace/rtl9607/product/access/rootfs/../../../app/net-snmp-5.6.2/ipkg-install/share/snmp/mibs"
...
#define NETSNMP_DEFAULT_MIBS ":SNMP-VIEW-BASED-ACM-MIB:SNMP-COMMUNITY-MIB:EPN104-MIB:EPN104ZG-MIB-V1:SNMPv2-MIB:IF-MIB:IP-MIB:TCP-MIB:UDP-MIB"
...
#define NETSNMP_PERSISTENT_DIRECTORY "/tmp/snmp/"
...
#define SNMPLIBPATH "/opt/workspace/rtl9607/product/access/rootfs/../../../app/net-snmp-5.6.2/ipkg-install/lib/snmp"
#define SNMPSHAREPATH "/opt/workspace/rtl9607/product/access/rootfs/../../../app/net-snmp-5.6.2/ipkg-install/share/snmp"
#define SNMPCONFPATH "/opt/workspace/rtl9607/product/access/rootfs/../../../app/net-snmp-5.6.2/ipkg-install/etc/snmp"
#define SNMPDLMODPATH "/opt/workspace/rtl9607/product/access/rootfs/../../../app/net-snmp-5.6.2/ipkg-install/lib/snmp/dlmod"
...
#define NETSNMP_LOGFILE "/tmp/log/snmpd.log"
...
#define NETSNMP_ENTERPRISE_OID 17409
#define NETSNMP_ENTERPRISE_MIB 1,3,6,1,4,1,17409
#define NETSNMP_ENTERPRISE_DOT_MIB 1.3.6.1.4.1.17409
#define NETSNMP_ENTERPRISE_DOT_MIB_LENGTH	7

/* The assigned enterprise number for sysObjectID. */
#define NETSNMP_SYSTEM_MIB 1,3,6,1,4,1,17409,1,15
#define NETSNMP_SYSTEM_DOT_MIB 1.3.6.1.4.1.17409.1.15
#define NETSNMP_SYSTEM_DOT_MIB_LENGTH 9

/* The assigned enterprise number for notifications. */
#define NETSNMP_NOTIFICATION_MIB 1,3,6,1,4,17409
#define NETSNMP_NOTIFICATION_DOT_MIB 1.3.6.1.4.17409
#define NETSNMP_NOTIFICATION_DOT_MIB_LENGTH 6
