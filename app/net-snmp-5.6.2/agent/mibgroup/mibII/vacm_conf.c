...
#define CONTEXTNAMEINDEXLEN 32
...
#endif
    {
      ...
      if (find_sec_mod(pdu->securityModel)) {
         ...
         */
        /*Begin add by huangmingjian 2013/01/24 for EPN104QID0089:snmp*/ 
		if(!v3_ip_check(pdu->transport_data))
		{
			DEBUGMSG(("netsnmp_udp_getSecName", "v3 ip check fail\n"));
       		snmp_increment_statistic(STAT_SNMPINBADCOMMUNITYNAMES);
			return VACM_NOSECNAME;
		}
		/*End add by huangmingjian 2013/01/24 for EPN104QID0089:snmp*/
