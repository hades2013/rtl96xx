...
#ifndef __SNMP_IPC_INTERFACE_H__
#define __SNMP_IPC_INTERFACE_H__
...
void send_alarmtrap(int index, AnalogProperty_t *pinfo);
#endif
#endif /*#ifndef __SNMP_IPC_INTERFACE_H__*/
