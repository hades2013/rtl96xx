...
#define MAXVIFS 512 /* modify by l03601 for debug cmd "ip mroute" SHD08548, 2008-12-24 */
#ifndef MAXVIFS /* begin modified by liujiaquan for SHD05470 */
static char *viftable[32];
#else
static char *viftable[MAXVIFS];
#endif          /* end modified by liujiaquan for SHD05470 */
...
static void read_mroute_list(FILE *ofp)
{
	...
	while (fgets(buf, sizeof(buf), fp)) {
        ...
        /* BEGIN: modify by l03601 for debug cmd "ip mroute" SHD08548, 2008-12-24 */
        #if 0
		char oiflist[256];
        #else
        char tmpoif[256];
        char *oiflist = tmpoif;
        #endif
        /* END: modify by l03601  for debug cmd "ip mroute" SHD08548, 2008-12-24 */
        ...
        oiflist = strstr(buf, oiflist); /* modify by l03601 for debug cmd "ip mroute" SHD08548, 2008-12-24 */
		if (oiflist[0]) {
			char *next = NULL;
			char *p = oiflist;
			int ovifi, ottl;
