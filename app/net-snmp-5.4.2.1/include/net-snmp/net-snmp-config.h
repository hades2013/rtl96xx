...
#define NETSNMP_DEFAULT_MIBS ":SNMP-FRAMEWORK-MIB:SNMP-MPD-MIB:SNMP-USER-BASED-SM-MIB:SNMPv2-MIB:RFC1213-MIB:SNMP-VIEW-BASED-ACM-MIB:SNMP-COMMUNITY-MIB"

/* default location to look for mibs to load using the above tokens
   and/or those in the MIBS envrionment variable*/
#define NETSNMP_DEFAULT_MIBDIRS "$HOME/.snmp/mibs:/opt/workspace/ar7400/localsvn/app/../target/share/snmp/mibs"
...
#define SNMPLIBPATH "/opt/workspace/ar7400/localsvn/app/../target/lib/snmp"
#define SNMPSHAREPATH "/opt/workspace/ar7400/localsvn/app/../target/share/snmp"
#define SNMPCONFPATH "/opt/workspace/ar7400/localsvn/app/../target/etc/snmp"
#define SNMPDLMODPATH "/opt/workspace/ar7400/localsvn/app/../target/lib/snmp/dlmod"
...
#define NETSNMP_ENTERPRISE_OID 36368
#define NETSNMP_ENTERPRISE_MIB 1,3,6,1,4,1,36368
#define NETSNMP_ENTERPRISE_DOT_MIB 1.3.6.1.4.1.36368
#define NETSNMP_ENTERPRISE_DOT_MIB_LENGTH	7

/* The assigned enterprise number for sysObjectID. */
#define NETSNMP_SYSTEM_MIB 1,3,6,1,4,1,36368,1,1,1
#define NETSNMP_SYSTEM_DOT_MIB 1.3.6.1.4.1.36368.1.1.1
...
#define NETSNMP_CONFIGURE_OPTIONS "'--target=mipsel-openwrt-linux' '--host=mipsel-openwrt-linux' '--build=i386-redhat-linux' '--prefix=/opt/workspace/ar7400/localsvn/app/../target' '--disable-nls' '--disable-ipv6' '--enable-mini-agent' '--enable-static' '--with-endianness=little' '--with-logfile=/var/log/snmpd.log' '--with-persistent-directory=/usr/lib/snmp/' '--with-default-snmp-version=2' '--with-sys-contact=root@localhost' '--with-sys-location=Unknown' '--with-enterprise-oid=36368' '--with-enterprise-sysoid=1.3.6.1.4.1.36368.1.1.1' '--disable-applications' '--disable-manuals' '--disable-mibs' '--disable-mib-loading' '--disable-scripts' '--without-openssl' '--without-libwrap' '--without-rpm' '--without-zlib' '--with-out-transports=TCP TCPIPv6 Unix' '--with-transports=Callback UDP ' '--with-out-mib-modules=agent_mibs agentx disman/event disman/schedule hardware host if-mib mibII notification notification-log-mib snmpv3mibs target tcp-mib ucd_snmp udp-mib utilities ' '--with-mib-modules=mibII/at mibII/icmp mibII/ifTable mibII/ip mibII/snmp_mib mibII/sysORTable mibII/system_mib mibII/tcp mibII/udp snmpv3/snmpEngine snmpv3/snmpMPDStats snmpv3/usmConf snmpv3/usmStats snmpv3/usmUser hexicom/hexicom hexicom/eocCLTSystemInfo hexicom/eocCLTConfigSystem hexicom/cltConfigNetworking hexicom/cltDeviceModelTable hexicom/eocCLTDebug hexicom/cltConfigCableTable hexicom/cltConfigCableScalar hexicom/cltConfigAdministratorTable hexicom/cltConfigRemoteUpgrade hexicom/cltConfigRTC hexicom/cltConfigService hexicom/eocCLTConfigInterface hexicom/cltConfigInterfaceTable hexicom/eocCLTNetworkUnitGroup hexicom/eocCLTNetworkUnitScalarGroup hexicom/cltNetworkUnitTopologyTable hexicom/cltNetworkUnitInterfaceTable hexicom/cltNetworkUnitStatisticsTable hexicom/cltTemplateTable hexicom/cltTemplateInterfaceTable hexicom/cltNetworkUnitUserListTable hexicom/eocCLTConfigVLAN hexicom/cltConfigVLANTable hexicom/cltConfigVLANTrunkTable hexicom/cltConfigVLANHybridTable ' 'CC=mipsel-openwrt-linux-uclibc-gcc' 'CFLAGS=-Os -pipe -mips32 -mtune=mips32 -funit-at-a-time -fhonour-copts -msoft-float -fpic -I/opt/workspace/ar7400/localsvn/app/shared -Wall' 'CPPFLAGS=-I/home/ryan/openwrt/trunk/staging_dir/toolchain-mipsel_gcc-4.3.3+cs_uClibc-0.9.31/usr/include -I/home/ryan/openwrt/trunk/staging_dir/toolchain-mipsel_gcc-4.3.3+cs_uClibc-0.9.31/include' 'CXXFLAGS=-Os -Wall -pipe -mips32 -mtune=mips32 -funit-at-a-time -fhonour-copts -msoft-float -fpic' 'CXX=mipsel-openwrt-linux-uclibc-g++ ' 'LDFLAGS=-lshared -L/opt/workspace/ar7400/localsvn/app/shared ' 'build_alias=i386-redhat-linux' 'host_alias=mipsel-openwrt-linux' 'target_alias=mipsel-openwrt-linux'"
