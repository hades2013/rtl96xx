...
struct vty 
{
  ...
  /* Use to store cmd paras. */    
  CMD_PARA_S para; 
    
  /* User name of this vty. */
  char *username;
...
#define TELNET_NAWS_SB_LEN 5
  ...
  /* the key we hit is del or not*/
  int is_del; 
  /* the key we hit is letf and right arrow or not*/
  int is_letf_and_right;
...
extern void vty_event(enum event event, int sock, struct vty *vty);
