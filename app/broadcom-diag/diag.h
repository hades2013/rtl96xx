...
static struct timer_list eoc_reset_timer = TIMER_INITIALIZER(&eoc_do_reset, 0, 0);
...
static struct prochandler_t proc_eoc_reset = { .type = PROC_EOC_RESET };
