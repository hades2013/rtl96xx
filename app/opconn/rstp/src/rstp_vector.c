...
**    FILE       :  rstp_vector.c
**      
**    DESCRIPTION:  This file contains STP priority vectors API.   
**    
**
**    NOTES      :  None.
**
...
{
  OP_DEBUG(DEBUG_LEVEL_DEBUGGING, "%s=%04lX-%02x%02x%02x%02x%02x%02x",
            title,
  ...
  OP_DEBUG(DEBUG_LEVEL_DEBUGGING, cr ? "\n" : " ");
}

void
STP_VECT_print (IN char *title, IN PRIO_VECTOR_T *v)
{
  OP_DEBUG(DEBUG_LEVEL_DEBUGGING, "%s:", title);
...
/****/
  OP_DEBUG(DEBUG_LEVEL_DEBUGGING, " dp=%lx bp=%lx ",
