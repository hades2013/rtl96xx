...
**    FILE       :  rstp_pcost.c
**      
**    DESCRIPTION:  This file contains Path Cost monitoring state machine. 
**    
**
**    NOTES      :  None.
**
...
/* Path Cost monitoring state machine : 802.1D 2004 Edition*/
 
#include "rstp_base.h"
#include "rstp_stpm.h"
#include "rstp_to.h" /* for STP_OUT_get_port_oper_speed */
