...
typedef struct port_t {
  ...
  //rzhou del and add
  //STATE_MACH_T*     edge;      /*  */
  STATE_MACH_T*     portrcv;     /*  */
  STATE_MACH_T*     bridect;     /*  */
  ...
  /*rzhou add fdbFlush,agree*/
  Bool              fdbFlush;     /*17.31 802.1D-2004*/
  Bool              agree;        
  Bool              disputed; 
