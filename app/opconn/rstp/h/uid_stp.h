...
**    FILE       :  rstp_uid.c
**      
**    DESCRIPTION:  This file contains External management communication API 
**    definitions.
**    
**
**    NOTES      :  None.
...
typedef struct {
  ...
  int           path_cost;
  int           priority;
  int           edge_port;//0 no 1 yes
  int			p2plink;//o half 1 full
} UID_PORT_CFG_T;
...
extern UID_STP_CFG_T uid_cfg;

extern UID_PORT_CFG_T port_cfg[NUMBER_OF_PORTS];
