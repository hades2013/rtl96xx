...
/* $Id: //depot/sw/abu/opconn/release/v3.2.1/apps/opconn/sys/h/mtd.h#1 $ */
...
extern int write_flash(const char *imagefile, const char * dev);
extern int erase_partition(const char * dev);
