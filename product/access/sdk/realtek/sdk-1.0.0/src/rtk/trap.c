...
rtk_trap_igmpCtrlPkt2CpuEnable_get(rtk_enable_t *pEnable)
{
    ...
    if (NULL == RT_MAPPER->trap_igmpCtrlPkt2CpuEnable_get)
        return RT_ERR_DRIVER_NOT_FOUND;
...
rtk_trap_igmpCtrlPkt2CpuEnable_set(rtk_enable_t enable)
{
    ...
    if (NULL == RT_MAPPER->trap_igmpCtrlPkt2CpuEnable_set)
        return RT_ERR_DRIVER_NOT_FOUND;
...
rtk_trap_mldCtrlPkt2CpuEnable_get(rtk_enable_t *pEnable)
{
    ...
    if (NULL == RT_MAPPER->trap_mldCtrlPkt2CpuEnable_get)
        return RT_ERR_DRIVER_NOT_FOUND;
...
rtk_trap_mldCtrlPkt2CpuEnable_set(rtk_enable_t enable)
{
    ...
    if (NULL == RT_MAPPER->trap_mldCtrlPkt2CpuEnable_set)
        return RT_ERR_DRIVER_NOT_FOUND;
...
rtk_trap_portIgmpMldCtrlPktAction_get(rtk_port_t port, rtk_trap_igmpMld_type_t igmpMldType, rtk_action_t *pAction)
{
    ...
    /* function body */
    RTK_API_LOCK();
    ret = RT_MAPPER->trap_portIgmpMldCtrlPktAction_get(port, igmpMldType, pAction);
    RTK_API_UNLOCK();
    return ret;
...
rtk_trap_portIgmpMldCtrlPktAction_set(rtk_port_t port, rtk_trap_igmpMld_type_t igmpMldType, rtk_action_t action)
{
    ...
    /* function body */
    RTK_API_LOCK();
    ret = RT_MAPPER->trap_portIgmpMldCtrlPktAction_set(port, igmpMldType, action);
    RTK_API_UNLOCK();
    return ret;
...
rtk_trap_ipMcastPkt2CpuEnable_get(rtk_enable_t *pEnable)
{
    ...
    if (NULL == RT_MAPPER->trap_ipMcastPkt2CpuEnable_get)
        return RT_ERR_DRIVER_NOT_FOUND;
...
{
    int32   ret;
    if (NULL == RT_MAPPER->trap_ipMcastPkt2CpuEnable_set)
        return RT_ERR_DRIVER_NOT_FOUND;
    RTK_API_LOCK();
...
{
    int32   ret;
    if (NULL == RT_MAPPER->trap_l2McastPkt2CpuEnable_get)
        return RT_ERR_DRIVER_NOT_FOUND;
    RTK_API_LOCK();
...
{
    int32   ret;
    if (NULL == RT_MAPPER->trap_l2McastPkt2CpuEnable_set)
        return RT_ERR_DRIVER_NOT_FOUND;
    RTK_API_LOCK();
...
{
    int32   ret;
    if (NULL == RT_MAPPER->trap_rmaPri_get)
        return RT_ERR_DRIVER_NOT_FOUND;
...
{
    int32   ret;
    if (NULL == RT_MAPPER->trap_rmaPri_set)
        return RT_ERR_DRIVER_NOT_FOUND;
...
rtk_trap_oamPduPri_get(rtk_pri_t *pPriority)
{
    ...
    if (NULL == RT_MAPPER->trap_oamPduPri_get)
        return RT_ERR_DRIVER_NOT_FOUND;
...
rtk_trap_oamPduPri_set(rtk_pri_t priority)
{
    ...
    if (NULL == RT_MAPPER->trap_oamPduPri_set)
        return RT_ERR_DRIVER_NOT_FOUND;
