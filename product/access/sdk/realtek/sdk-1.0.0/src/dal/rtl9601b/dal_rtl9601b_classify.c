 ...
 *
 * $Revision: 41309 $
 * $Date: 2013-07-19 14:18:21 +0800 (Fri, 19 Jul 2013) $
 *
...
int32 rtl9601b_raw_cf_rule_set(rtl9601b_raw_cf_RuleEntry_t *pattern)
{
	...
	RT_PARAM_CHK(pattern->care_bits.aclHit > (0x80|(RTL9601B_MAX_NUM_OF_ACL_ACTION-1)), RT_ERR_OUT_OF_RANGE);
	...
	RT_PARAM_CHK(pattern->data_bits.aclHit > (0x80|(RTL9601B_MAX_NUM_OF_ACL_ACTION-1)), RT_ERR_OUT_OF_RANGE);
	...
	{
		RT_PARAM_CHK(pattern->care_bits.tos_gemidx >= RTL9601B_CLASSIFY_SID_MAX, RT_ERR_OUT_OF_RANGE);
...
int32 rtl9601b_raw_cf_usAct_set(rtl9601b_raw_cf_usAct_t *pCfUsAct)
{
	...
	RT_PARAM_CHK(pCfUsAct->assign_idx >= RTL9601B_CLASSIFY_SID_MAX, RT_ERR_OUT_OF_RANGE);
