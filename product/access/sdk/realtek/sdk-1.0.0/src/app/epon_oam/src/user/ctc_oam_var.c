                                          ...
                                          */
{
    ...
    case CTC_OAM_VAR_AFECMODE_ENABLED:
        do {
            ...
            ret = rtk_epon_dsFecState_set(ENABLED);
            if(RT_ERR_OK != ret)
            {
                pVarContainer->varWidth = CTC_OAM_VAR_RESP_VARNORESOURCE;
                break;
    ...
    case CTC_OAM_VAR_AFECMODE_DISABLED:
        do {
            ...
            ret = rtk_epon_dsFecState_set(DISABLED);
            if(RT_ERR_OK != ret)
            {
                pVarContainer->varWidth = CTC_OAM_VAR_RESP_VARNORESOURCE;
                break;
                                          ...
                                          */
{
    ...
    memcpy(pPtr, hwVerStr, sizeof(hwVerStr) > 16 ? 16 : sizeof(hwVerStr));
    pPtr += 16;
