...
/*
 * pon set scheduling type ( wrr | wfq ) 
 */
cparser_result_t
cparser_cmd_pon_set_scheduling_type_wrr_wfq(
    cparser_context_t *context)
{
    ...
    return CPARSER_OK;
}    /* end of cparser_cmd_pon_set_scheduling_type_wrr_wfq */
...
/*
* pon get transceiver ( vendor-name | part-number | temperature | voltage | tx-power | rx-power )
*/
cparser_result_t
cparser_cmd_pon_get_transceiver_vendor_name_part_number_temperature_voltage_tx_power_rx_power(
    cparser_context_t *context)
{
