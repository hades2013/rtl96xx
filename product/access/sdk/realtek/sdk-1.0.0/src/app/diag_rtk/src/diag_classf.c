...
uint32 _diag_classf_show_usAction(rtk_classify_us_act_t *pAct)
{
    ...
    if(APOLLOMP_CHIP_ID == DIAG_UTIL_CHIP_TYPE || RTL9601B_CHIP_ID == DIAG_UTIL_CHIP_TYPE )
    {
 ...
 */
cparser_result_t
cparser_cmd_classf_set_upstream_action_svlan_priority_act_copy_outer_copy_inner_internal_priority_priority(
    cparser_context_t *context,
    uint32_t  *priority_ptr)
 ...
 */
cparser_result_t
cparser_cmd_classf_set_upstream_action_cvlan_priority_act_copy_outer_copy_inner_internal_priority_priority(
    cparser_context_t *context,
    uint32_t  *priority_ptr)
{
    DIAG_UTIL_PARAM_CHK();
 ...
 */
cparser_result_t
cparser_cmd_classf_set_downstream_action_svlan_priority_act_copy_outer_copy_inner_internal_priority_priority(
    cparser_context_t *context,
    uint32_t  *priority_ptr)
{
    DIAG_UTIL_PARAM_CHK();
 ...
 */
cparser_result_t
cparser_cmd_classf_set_downstream_action_cvlan_id_act_follow_swcore_copy_outer_copy_inner_lookup_table_vid(
    cparser_context_t *context,
    uint32_t  *vid_ptr)
{
    DIAG_UTIL_PARAM_CHK();
 ...
 */
cparser_result_t
cparser_cmd_classf_set_downstream_action_cvlan_priority_act_follow_swcore_copy_outer_copy_inner_internal_priority_priority(
    cparser_context_t *context,
    uint32_t  *priority_ptr)
{
    DIAG_UTIL_PARAM_CHK();
 ...
 */
cparser_result_t
cparser_cmd_classf_set_upstream_action_sid_act_nop(
    cparser_context_t *context)
{
	DIAG_UTIL_PARAM_CHK();
	...
	return CPARSER_OK;
}    /* end of cparser_cmd_classf_set_upstream_action_sid_act_nop */

/*
 * classf set downstream-action uni-forward-act nop */
cparser_result_t
cparser_cmd_classf_set_downstream_action_uni_forward_act_nop(
    cparser_context_t *context)
{
    DIAG_UTIL_PARAM_CHK();
