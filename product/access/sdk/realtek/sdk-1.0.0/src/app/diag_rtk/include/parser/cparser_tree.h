...
cparser_result_t cparser_cmd_classf_set_upstream_action_svlan_priority_act_copy_outer_copy_inner_internal_priority_priority(cparser_context_t *context,
    uint32_t *priority_ptr);
...
cparser_result_t cparser_cmd_classf_set_upstream_action_cvlan_priority_act_assign_priority(cparser_context_t *context,
    uint32_t *priority_ptr);
cparser_result_t cparser_cmd_classf_set_upstream_action_cvlan_priority_act_copy_outer_copy_inner_internal_priority_priority(cparser_context_t *context,
    uint32_t *priority_ptr);
cparser_result_t cparser_cmd_classf_set_upstream_action_sid_act_sid_qid_id(cparser_context_t *context,
    uint32_t *id_ptr);
cparser_result_t cparser_cmd_classf_set_upstream_action_sid_act_nop(cparser_context_t *context);
...
cparser_result_t cparser_cmd_classf_set_downstream_action_svlan_priority_act_assign_priority(cparser_context_t *context,
    uint32_t *priority_ptr);
cparser_result_t cparser_cmd_classf_set_downstream_action_svlan_priority_act_copy_outer_copy_inner_internal_priority_priority(cparser_context_t *context,
    uint32_t *priority_ptr);
...
cparser_result_t cparser_cmd_classf_set_downstream_action_cvlan_id_act_follow_swcore_copy_outer_copy_inner_lookup_table_vid(cparser_context_t *context,
    uint32_t *vid_ptr);
cparser_result_t cparser_cmd_classf_set_downstream_action_cvlan_id_act_assign_cvid(cparser_context_t *context,
    uint32_t *cvid_ptr);
cparser_result_t cparser_cmd_classf_set_downstream_action_cvlan_priority_act_follow_swcore_copy_outer_copy_inner_internal_priority_priority(cparser_context_t *context,
    uint32_t *priority_ptr);
...
cparser_result_t cparser_cmd_classf_set_downstream_action_uni_forward_act_flood_forced_port_ports_all_none(cparser_context_t *context,
    char **ports_ptr);
cparser_result_t cparser_cmd_classf_set_downstream_action_uni_forward_act_nop(cparser_context_t *context);
...
cparser_result_t cparser_cmd_acl_set_reason_cvlan_svlan_priority_policing_forward_extend(cparser_context_t *context);
...
cparser_result_t cparser_cmd_vlan_get_leaky_ip_mcast_port_ports_all_state(cparser_context_t *context,
    char **ports_ptr);
cparser_result_t cparser_cmd_vlan_get_leaky_cdp_csstp_state(cparser_context_t *context);
...
cparser_result_t cparser_cmd_vlan_set_leaky_ip_mcast_port_ports_all_state_enable_disable(cparser_context_t *context,
    char **ports_ptr);
cparser_result_t cparser_cmd_vlan_set_leaky_cdp_csstp_state_enable_disable(cparser_context_t *context);
...
cparser_result_t cparser_cmd_debug_gpio_set_pin_gpioId_databit_value(cparser_context_t *context,
    uint32_t *gpioId_ptr,
    uint32_t *value_ptr);
cparser_result_t cparser_cmd_debug_gpio_set_intr_intrId_state_enable_disable(cparser_context_t *context,
    uint32_t *intrId_ptr);
...
cparser_result_t cparser_cmd_debug_gpio_get_pin_gpioId_databit(cparser_context_t *context,
    uint32_t *gpioId_ptr);
cparser_result_t cparser_cmd_debug_gpio_get_intr_intrId_state(cparser_context_t *context,
    uint32_t *intrId_ptr);
...
cparser_result_t cparser_cmd_interrupt_set_mask_all_link_change_meter_exceed_learn_over_speed_change_special_congestion_loop_detection_cable_diag_acl_gphy_serdes_gpon_epon_ptp_dying_gasp_thermal_adc_state_disable_enable(cparser_context_t *context);
cparser_result_t cparser_cmd_interrupt_set_polarity_high_low(cparser_context_t *context);
cparser_result_t cparser_cmd_interrupt_get_mask_all_link_change_meter_exceed_learn_over_speed_change_special_congestion_loop_detection_cable_diag_acl_gphy_serdes_gpon_epon_ptp_dying_gasp_thermal_adc_state(cparser_context_t *context);
cparser_result_t cparser_cmd_interrupt_get_status_all_link_change_meter_exceed_learn_over_speed_change_special_congestion_loop_detection_cable_diag_acl_gphy_serdes_gpon_epon_ptp_dying_gasp_thermal_adc(cparser_context_t *context);
...
cparser_result_t cparser_cmd_interrupt_clear_status_all_link_change_meter_exceed_learn_over_speed_change_special_congestion_loop_detection_cable_diag_acl_gphy_serdes_gpon_epon_ptp_dying_gasp_thermal_adc(cparser_context_t *context);
...
cparser_result_t cparser_cmd_epon_de_active_llid_idx_value(cparser_context_t *context,
    uint32_t *value_ptr);
cparser_result_t cparser_cmd_epon_dump_mib_counter(cparser_context_t *context);
cparser_result_t cparser_cmd_epon_reset_mib_counter(cparser_context_t *context);
...
cparser_result_t cparser_cmd_pon_set_llid_llid_queue_id_qid_egress_drop_state_enable_disable(cparser_context_t *context,
    uint32_t *llid_ptr,
    uint32_t *qid_ptr);
cparser_result_t cparser_cmd_pon_set_scheduling_type_wrr_wfq(cparser_context_t *context);
...
cparser_result_t cparser_cmd_led_set_group_index_type_utp_port_port(cparser_context_t *context,
    uint32_t *index_ptr,
    uint32_t *port_ptr);
cparser_result_t cparser_cmd_led_set_group_index_type_fiber_pon_usb0_usb1_sata(cparser_context_t *context,
    uint32_t *index_ptr);
...
cparser_result_t cparser_cmd_led_set_group_index_source_speed_10M_100M_500M_1000M_mode_link_act_state_enable_disable(cparser_context_t *context,
    uint32_t *index_ptr);
cparser_result_t cparser_cmd_led_set_group_index_force_on_off_blinking(cparser_context_t *context,
    uint32_t *index_ptr);
cparser_result_t cparser_cmd_led_set_group_index_parallel_state_enable_disable(cparser_context_t *context,
    uint32_t *index_ptr);
cparser_result_t cparser_cmd_led_set_blinking_port_force_usb_sata_rate_blink_32_blink_48_blink_64_blink_96_blink_128_blink_256_blink_512_blink_1024(cparser_context_t *context);
