...
/*
 * led set group <UINT:index> type ( fiber | pon | usb0 | usb1 | sata )
 */
cparser_result_t
cparser_cmd_led_set_group_index_type_fiber_pon_usb0_usb1_sata(
    cparser_context_t *context,
    uint32_t  *index_ptr)
{
    int32     ret = RT_ERR_FAILED;
...
/*
 * led set group <UINT:index> force ( on | off | blinking ) 
 */
cparser_result_t
cparser_cmd_led_set_group_index_force_on_off_blinking(
    cparser_context_t *context,
    uint32_t  *index_ptr)
{
    int32     ret = RT_ERR_FAILED;
    ...
    return CPARSER_OK;
}    /* end of cparser_cmd_led_set_group_index_force_on_off_blinking */
...
/*
 * led set blinking ( port | force | usb | sata ) rate ( blink-32 | blink-48 | blink-64 | blink-96 | blink-128 | blink-256 | blink-512 | blink-1024 ) 
 */
cparser_result_t
cparser_cmd_led_set_blinking_port_force_usb_sata_rate_blink_32_blink_48_blink_64_blink_96_blink_128_blink_256_blink_512_blink_1024(
    cparser_context_t *context)
{
    int32     ret = RT_ERR_FAILED;
