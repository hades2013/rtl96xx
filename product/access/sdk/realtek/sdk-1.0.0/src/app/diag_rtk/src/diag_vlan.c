 ...
 */
cparser_result_t
cparser_cmd_vlan_set_leaky_cdp_csstp_state_enable_disable(
    cparser_context_t *context)
{
    int32 ret = RT_ERR_FAILED;
    ...
    return CPARSER_OK;
}    /* end of cparser_cmd_vlan_set_leaky_cdp_csstp_state_enable_disable */

/*
 * vlan get leaky ( cdp | csstp ) state
 */
cparser_result_t
cparser_cmd_vlan_get_leaky_cdp_csstp_state(
    cparser_context_t *context)
{
    int32 ret = RT_ERR_FAILED;
    rtk_leaky_type_t type;
    ...
    return CPARSER_OK;
}    /* end of cparser_cmd_vlan_get_leaky_cdp_csstp_state */
