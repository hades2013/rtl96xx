...
typedef struct netvd_hal_mapper {
	...
	int (*hal_netif_ip_set)(uint32 netifId, uint32 ipaddr, uint32 prefix);
	...
	int (*hal_ct_add)(struct nf_conn *ct, uint32 *naptId);
