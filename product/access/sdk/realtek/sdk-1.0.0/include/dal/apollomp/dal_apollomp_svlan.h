...
extern int32 dal_apollomp_svlan_checkAndDestroy(rtk_vlan_t svid);
extern int32 dal_apollomp_svlan_checkAndDestroyAll(void);
 ...
 */
extern int32
dal_apollomp_svlan_priority_set(rtk_vlan_t vid, rtk_pri_t priority);
