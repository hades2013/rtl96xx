...
oam-vendor:
	$(MAKE) -C $(PRODUCTDIR)/app/epon_oam LIBVENDOR
oam-vendor-clean:
	$(MAKE) -C $(PRODUCTDIR)/app/epon_oam LIBVENDOR-clean
sdk-app-clean:
...
rootfs:sdk-app
	...
	echo $(CONFIGDIR)
	echo $(ROOTFSDIR)
	install -p $(CONFIGDIR)/passwd $(ROOTFSDIR)/etc/
	install -p $(CONFIGDIR)/passwd- $(ROOTFSDIR)/etc/
	install -p $(CONFIGDIR)/group $(ROOTFSDIR)/etc/
	install -p $(CONFIGDIR)/shells $(ROOTFSDIR)/etc/
