...
PORT_TYPE_S g_szPortType[LOGIC_PORT_NO+5] = {
...
/* 3 */    {TO_USERPORT(1, 0, 3),  TOPHYID(0,5),     PORT_TYPE_DEF(0,TP_CABLE, UD_DOWNLINK, SP_1000)},
/* 4 */    {TO_USERPORT(1, 0, 4),  TOPHYID(0,4),     PORT_TYPE_DEF(0,TP_COPPER, UD_DOWNLINK, SP_1000)},
...
PORT_TYPE_S g_szComboPortSecType[LOGIC_PORT_NO+5] = {
/* 0 */    {INVALID_PORT, INVALID_PORT, 0},
