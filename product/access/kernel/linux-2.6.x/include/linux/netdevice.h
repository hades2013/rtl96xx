...
#define NET_RX_L2STOLEN   6    /* accept by l2 hook*/
#endif
...
{   
    ...
    int	(*func) (struct sk_buff *,/*skb*/
				struct net_device *,/*cur dev*/
			    struct l2_hk_block * /*cur hook*/
				);    
    struct list_head list;
};
extern void		dev_add_l2trans(struct l2_hk_block *pt);
extern void		dev_remove_l2trans(struct l2_hk_block *pt);
extern int      l2_trans(struct sk_buff *skb);
#endif
