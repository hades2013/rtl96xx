...
#define SOC_HEADER_VERSION      0x00000922  // which means 0.0.9.34
...
typedef struct {
    ...
    u8_t size_per_chip;         /* in power of 2, should combine addr_mode to determine.
                                    3B mode: 17: 128KB, 18: 256KB, ..., 24: 16MB;
                                    4B mode: 17: 256KB, 18: 512KB, ..., 24: 32MB. */
...
typedef struct {
    ...
    //u32_t DDR1_dtr0;   //T_CAS-31:28,T_WR-27:24,T_CWL-23:20,T_RTP-19:16,T_WTR-15:12,T_REFI-11:8,T_REFI_UNIT-7:4
    //u32_t DDR1_dtr1;   //T_RP-28:24,T_RCD-20:16,T_RRD-12:8,T_FAWG-4:0
    //u32_t DDR1_dtr2;   //T_RFC-28:20,T_RAS-18:12
    //u32_t DDR2_dtr0;   //T_CAS-31:28,T_WR-27:24,T_CWL-23:20,T_RTP-19:16,T_WTR-15:12,T_REFI-11:8,T_REFI_UNIT-7:4
    //u32_t DDR2_dtr1;   //T_RP-28:24,T_RCD-20:16,T_RRD-12:8,T_FAWG-4:0
    //u32_t DDR2_dtr2;   //T_RFC-28:20,T_RAS-18:12
    //u32_t DDR3_dtr0;   //T_CAS-31:28,T_WR-27:24,T_CWL-23:20,T_RTP-19:16,T_WTR-15:12,T_REFI-11:8,T_REFI_UNIT-7:4
    //u32_t DDR3_dtr1;   //T_RP-28:24,T_RCD-20:16,T_RRD-12:8,T_FAWG-4:0
    //u32_t DDR3_dtr2;   //T_RFC-28:20,T_RAS-18:12
    ...
    //u8_t size_auto_detection;//0-disable, 1-enable(When enable, DCR is not required)
    ...
    //u8_t mrs_dll_enable;    //0-dll_enable, 1-dll_disable
    //u8_t mrs_drv_strength;  //0-normal, 1-reduced
    //u8_t mrs_odt;
    //u8_t mrs_additive_latency;
    //u8_t mrs_rtt_wr;
