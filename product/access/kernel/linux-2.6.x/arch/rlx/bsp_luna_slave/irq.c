...
{
	if(irq < 32) {
		REG32(BSP_GIMR0_1) &= (~(1 << irq));
	}else{
		REG32(BSP_GIMR1_1) &= (~(1 << (irq-32)));
	}
}
...
void __init bsp_irq_init(void)
{
   int i;
    ...
    write_c0_status(read_c0_status() | ST0_IM); 	
      ...
      /* Set GIMR, IRR */
     REG32(BSP_GIMR0_1) = BSP_TMO_IE | BSP_PERIPHERAL_IE;
     REG32(BSP_GIMR1_1) = BSP_TC4_IE | BSP_UART1_IE;

     REG32(BSP_IRR0_1) = BSP_IRR0_1_SETTING;
     REG32(BSP_IRR1_1) = BSP_IRR1_1_SETTING;
     REG32(BSP_IRR2_1) = BSP_IRR2_1_SETTING;
     REG32(BSP_IRR3_1) = BSP_IRR3_1_SETTING;
     REG32(BSP_IRR4_1) = BSP_IRR4_1_SETTING;
     REG32(BSP_IRR5_1) = BSP_IRR5_1_SETTING;
     REG32(BSP_IRR6_1) = BSP_IRR6_1_SETTING;
...
{
	unsigned int extint0_ip = REG32(BSP_GIMR0_1) & REG32(BSP_GISR0_1);
	unsigned int extint1_ip = REG32(BSP_GIMR1_1) & REG32(BSP_GISR1_1);
#if 0 /* 2012-3-15 krammer add */
	unsigned int extint2_ip = REG32(BSP_GIMR1_1) & REG32(BSP_GISR1_1);
#else
