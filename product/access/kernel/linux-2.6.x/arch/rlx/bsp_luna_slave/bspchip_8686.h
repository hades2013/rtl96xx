...
#define BSP_UART1_RS        	3
#define BSP_UART0_RS        	2
#define BSP_TC1_RS          		2
#define BSP_TC0_RS          		2
...
#define BSP_IRR0_1         0xB8003110
#define BSP_IRR0_1_SETTING    ((BSP_LBCTMOm2_RS << 28) | \
					(BSP_LBCTMOm1_RS << 24) | \
					(BSP_LBCTMOm0_RS << 20) | \
					(BSP_LBCTMOs3_RS << 16) | \
					(BSP_LBCTMOs2_RS << 12) | \
...
#define BSP_IRR1_1          0xB8003114
#define BSP_IRR1_1_SETTING    ((BSP_OCPTO0_RS << 28) | \
...
#define BSP_IRR2_1           0xB8003118
#define BSP_IRR2_1_SETTING    ((BSP_SAR_RS << 28) | \
					(BSP_PKT_GMAC_RS << 24) | \
					(BSP_PKT_XTM_RS << 20) | \
					(BSP_DMT_RS << 16) | \
					(BSP_GDMA1_RS << 12) | \
...
#define BSP_IRR3_1           0xB800311C
#define BSP_IRR3_1_SETTING    ((BSP_PCM0_RS << 28) | \
					(BSP_PCIE1_RS << 24) | \
					(BSP_PCIE0_RS << 20) | \
					(BSP_USB_H2_RS << 16) | \
					(BSP_USB_H3_RS << 12) | \
...
#define BSP_IRR4_1           0xB8003120
#define BSP_IRR4_1_SETTING    ((BSP_UART0_RS << 28) | \
					(BSP_TC5_RS << 24) | \
					(BSP_TC4_RS << 20) | \
					(BSP_TC3_RS << 16) | \
					(BSP_TC2_RS << 12) | \
...
#define BSP_IRR5_1           0xB8003124
#define BSP_IRR5_1_SETTING    ((BSP_GPIO0_RS << 28) | \
					(BSP_SWITCH_RS << 24) | \
					(BSP_SATA_RS << 20) | \
					(BSP_NFBI_RS << 16) | \
					(BSP_WDOG_RS << 12) | \
...
#define BSP_IRR6_1           0xB8003128
#define BSP_IRR6_1_SETTING    ((BSP_CUP0_T_CPU1_RS << 28) | \
...
#define BSP_WDTCTRLR        (BSP_TC_BASE + 0x24)
...
#define BSP_SYS_CLK_SEL 0xBB000284
...
static int inline IS_0371(void){
	REG32(CHIP_ID_REG)=0xa0000000;
	return (((REG32(CHIP_ID_REG)&0x0000ffff) == 0x0371) ? 1:0);
}
//krammer mark
//#define IS_RTL8686 (IS_0371())
#define IS_RTL8686		1
#define IS_RTL8685		0
