...
//	ODM_SetRFReg(pDM_Odm, RF_PATH_A, RF_WE_LUT, 0x80000, 0x1);	               // 0xEF[19]   = 0x1
	ODM_SetRFReg(pDM_Odm, RF_PATH_A, RF_RCK_OS, bRFRegOffsetMask, 0x30000 );  // 0x30[19:0] = 0x18000
	ODM_SetRFReg(pDM_Odm, RF_PATH_A, RF_TXPA_G1, bRFRegOffsetMask, 0x0000f ); // 0x31[19:0] = 0x0000f
	ODM_SetRFReg(pDM_Odm, RF_PATH_A, RF_TXPA_G2, bRFRegOffsetMask, 0xf7ffa ); // 0x32[19:0] = 0xf7ffa
//	ODM_SetRFReg(pDM_Odm, RF_PATH_A, RF_WE_LUT, 0x80000, 0x0);	               // 0xEF[19]   = 0x0
	//	PA/PAD control by 0x56, and set = 0x0
	ODM_SetRFReg(pDM_Odm, RF_PATH_A, 0xdf, bRFRegOffsetMask, 0x980 );
	ODM_SetRFReg(pDM_Odm, RF_PATH_A, 0x56, bRFRegOffsetMask, 0x51000 );
...
//	ODM_RT_TRACE(pDM_Odm,ODM_COMP_CALIBRATION, ODM_DBG_LOUD, ("Path-B Rx IQK modify RXIQK mode table!\n"));
	...
	ODM_SetRFReg(pDM_Odm, RF_PATH_B, RF_TXPA_G2, bRFRegOffsetMask, 0xf117b );
...
//	ODM_RT_TRACE(pDM_Odm,ODM_COMP_CALIBRATION, ODM_DBG_LOUD, ("Path-B Rx IQK modify RXIQK mode table 2!\n"));
	...
	//<20121009, Kordan> RF Mode = 3
//	ODM_SetRFReg(pDM_Odm, RF_PATH_A, RF_WE_LUT, 0x80000, 0x1);	               // 0xEF[19]   = 0x1
	ODM_SetRFReg(pDM_Odm, RF_PATH_B, RF_RCK_OS, bRFRegOffsetMask, 0x30000 );  // 0x30[19:0] = 0x18000
	ODM_SetRFReg(pDM_Odm, RF_PATH_B, RF_TXPA_G1, bRFRegOffsetMask, 0x0000f ); // 0x31[19:0] = 0x0000f
	ODM_SetRFReg(pDM_Odm, RF_PATH_B, RF_TXPA_G2, bRFRegOffsetMask, 0xf7ffa ); // 0x32[19:0] = 0xf7ffa
//	ODM_SetRFReg(pDM_Odm, RF_PATH_A, RF_WE_LUT, 0x80000, 0x0);	               // 0xEF[19]   = 0x0
	//	PA/PAD all off
	ODM_SetRFReg(pDM_Odm, RF_PATH_B, 0xdf, bRFRegOffsetMask, 0x980 );
	ODM_SetRFReg(pDM_Odm, RF_PATH_B, 0x56, bRFRegOffsetMask, 0x51000 );
