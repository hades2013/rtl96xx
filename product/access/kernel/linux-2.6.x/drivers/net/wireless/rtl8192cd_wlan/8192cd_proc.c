...
void MDL_DEVINIT rtl8192cd_proc_init(struct net_device *dev)
{
	...
	if ( (p = create_proc_read_entry ("mib_rf", 0644, rtl8192cd_proc_root,
	...
	p->size = 0x1000;
	#endif
	if ( (p = create_proc_read_entry ("mib_operation", 0644, rtl8192cd_proc_root,
	...
	if ( (p = create_proc_read_entry ("mib_staconfig", 0644, rtl8192cd_proc_root,
	...
	if ( (p = create_proc_read_entry ("mib_dkeytbl", 0644, rtl8192cd_proc_root,
	...
	if ( (p = create_proc_read_entry ("mib_auth", 0644, rtl8192cd_proc_root,
	...
	if ( (p = create_proc_read_entry ("mib_gkeytbl", 0644, rtl8192cd_proc_root,
	...
	if ( (p = create_proc_read_entry ("mib_bssdesc", 0644, rtl8192cd_proc_root,
	...
	if ( (p = create_proc_read_entry ("sta_info", 0644, rtl8192cd_proc_root,
	...
	if ( (p = create_proc_read_entry ("sta_keyinfo", 0644, rtl8192cd_proc_root,
	...
	if ( (p = create_proc_read_entry ("sta_dbginfo", 0644, rtl8192cd_proc_root,
	...
	if ( (p = create_proc_read_entry ("mib_erp", 0644, rtl8192cd_proc_root,
...
#ifdef RTK_BR_EXT
	if ( (p = create_proc_read_entry ("mib_brext", 0644, rtl8192cd_proc_root,
...
#if defined(CONFIG_RTL_8812_SUPPORT) || defined(CONFIG_WLAN_HAL_8881A)
	if ( (p = create_proc_read_entry ("mib_rf_ac", 0644, rtl8192cd_proc_root,
	...
	if ( (p = create_proc_read_entry ("mib_misc", 0644, rtl8192cd_proc_root,
...
#ifdef WIFI_SIMPLE_CONFIG
	if ( (p = create_proc_read_entry ("mib_wsc", 0644, rtl8192cd_proc_root,
...
#ifdef GBWC
	if ( (p = create_proc_read_entry ("mib_gbwc", 0644, rtl8192cd_proc_root,
	...
	if ( (p = create_proc_read_entry ("mib_11n", 0644, rtl8192cd_proc_root,
...
#ifdef SUPPORT_MULTI_PROFILE
	if ( (p = create_proc_read_entry ("mib_ap_profile", 0644, rtl8192cd_proc_root,
