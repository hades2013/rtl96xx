...
#define BSP_PCIE1_D_CFG0 	PCIE1_D_CFG0
...
//LUNA Dual Linux do not need to limit memory size
#if defined(CONFIG_LUNA_DUAL_LINUX) || defined(CONFIG_ARCH_LUNA_SLAVE)
#undef WIFI_LIMITED_MEM
#endif
...
#else
#if defined(CONFIG_RTL_8198) || defined(CONFIG_RTL_819XD) || defined(CONFIG_RTL_8196E) || defined(CONFIG_RTL_8198B) || (defined(CONFIG_LUNA_DUAL_LINUX) || defined(CONFIG_ARCH_LUNA_SLAVE))
...
#elif defined(CONFIG_RTL_8198) || defined(CONFIG_RTL_819XD) || defined(CONFIG_RTL_8196E) || (defined(CONFIG_LUNA_DUAL_LINUX) || defined(CONFIG_ARCH_LUNA_SLAVE))
	#if defined(CONFIG_RTL_DUAL_PCIESLOT_BIWLAN_D)
