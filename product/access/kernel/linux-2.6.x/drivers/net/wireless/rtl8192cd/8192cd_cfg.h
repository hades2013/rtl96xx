...
#endif
#elif defined(CONFIG_RTL_8196C) || defined(CONFIG_RTL8196C)
#define CFG_92C_SLOTH		CONFIG_SLOT0H
#define CFG_92C_SLOTS		CONFIG_SLOT0S
#define CFG_92D_SLOTH		CONFIG_SLOT0H
#define CFG_92D_SLOTS		CONFIG_SLOT0S
...
//-------------------------------------------------------------
#if !defined(CONFIG_RTL8196B_GW_8M) && !defined(CONFIG_WIRELESS_LAN_MODULE) && !defined(CONFIG_RTL8672)
#define PRIV_STA_BUF
#endif
...
#if defined(CONFIG_SLOT_0_HIGH_POWER) || defined(CONFIG_SLOT_1_HIGH_POWER)
#define HIGH_POWER_EXT_PA
#endif
...
#undef DRV_RELDATE
#define DRV_RELDATE		"2012-07-24/2013-03-14"
...
#if defined(CONFIG_RTL_8812_SUPPORT) && !defined(CONFIG_RTL_8198B)
...
#ifdef NUM_WLAN_IFACE
#define NUM_WL_IF	NUM_WLAN_IFACE
#else
#define NUM_WL_IF	1
#endif

#ifdef TPT_THREAD
#define LCK_INTERRUPTIBLE
#endif

#ifdef LCK_INTERRUPTIBLE
#ifdef CHECK_HANGUP
#define LCK_DELAY_MS(ms)	\
	do {\
...
#else
#define LCK_DELAY_MS(ms)	msleep(ms)
#endif // CHECK_HANGUP
#else
#define LCK_DELAY_MS(ms)	delay_ms(ms)
#endif // LCK_INTERRUPTIBLE
