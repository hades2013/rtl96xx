...
EXTERN INT8 PwrPercent2PwrLevel(int percentage);
#endif
...
EXTERN unsigned char *data_PHY_REG_PG_92C_FCC_start, *data_PHY_REG_PG_92C_FCC_end;
EXTERN unsigned char *data_PHY_REG_PG_92C_CE_start, *data_PHY_REG_PG_92C_CE_end;
...
EXTERN void execute_tx_pwr_tracking(struct rtl8192cd_priv *priv);
#ifdef TPT_THREAD
