...
//VHT CAPABILITIES INFO field
	...
	input_value_32(&vht_cap->vht_cap_info, MAX_ANT_SUPP_S, MAX_ANT_SUPP_E, 1);
...
//VHT SUPPORTED MCS SET field
	if(get_rf_mimo_mode(priv) == MIMO_1T1R) {
		value = 0xfffc; 	// MCS0-7
		input_value_32(&vht_cap->vht_support_mcs[0], MCS_RX_MAP_S, MCS_RX_MAP_E, value);
		...
		value = 0xfffc;
		input_value_32(&vht_cap->vht_support_mcs[1], MCS_TX_MAP_S, MCS_TX_MAP_E, value);
		value = (VHTMcsToDataRate(priv, vht_cap->vht_support_mcs)+1)>>1;
...
//		value = 600;
		value = (VHTMcsToDataRate(priv, vht_cap->vht_support_mcs)+1)>>1;
		input_value_32(&vht_cap->vht_support_mcs[0], MCS_RX_HIGHEST_RATE_S, MCS_RX_HIGHEST_RATE_E, value);
	//printk("vht_cap->vht_support_mcs[0] 0x%08X ", vht_cap->vht_support_mcs[0]);
	vht_cap->vht_support_mcs[0] = cpu_to_le32(vht_cap->vht_support_mcs[0]);
	//printk("0x%08X\n", vht_cap->vht_support_mcs[0]);
