			  ...
			  struct msghdr *msg, size_t len, int flags)
{
    ...
    if (msg->msg_control&&(msg->msg_controllen>=sizeof(struct l2_ctl_s)))
	{	
        ((struct l2_ctl_s *)(msg->msg_control))->sll_vlanid=skb->l2_vlan;
        ((struct l2_ctl_s *)(msg->msg_control))->sll_port=skb->l2_port;
	}
    #endif
