...
unsigned char support_lec_g168_bk[MAX_DSP_RTK_CH_NUM] = {[0 ... MAX_DSP_RTK_CH_NUM-1]=1};
...
unsigned char lec_g168_nlp_bk[MAX_DSP_RTK_CH_NUM] = {[0 ... MAX_DSP_RTK_CH_NUM-1]=0};
unsigned char lec_g168_cng_flag[MAX_DSP_RTK_CH_NUM] = {[0 ... MAX_DSP_RTK_CH_NUM-1]=0};
unsigned char lec_g168_cng_flag_bk[MAX_DSP_RTK_CH_NUM] = {[0 ... MAX_DSP_RTK_CH_NUM-1]=0};	// backup
short Attack_Stepsize[MAX_DSP_RTK_CH_NUM]= {[0 ... MAX_DSP_RTK_CH_NUM-1]=0xa3};	//0.005, Q15
short Attack_Stepsize_bk[MAX_DSP_RTK_CH_NUM]= {[0 ... MAX_DSP_RTK_CH_NUM-1]=0xa3};	//0.005, Q15, backup
...
short Release_Stepsize_bk[MAX_DSP_RTK_CH_NUM]= {[0 ... MAX_DSP_RTK_CH_NUM-1]=0xffae}; //-0.005, Q14           
