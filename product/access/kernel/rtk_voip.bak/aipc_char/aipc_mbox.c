...
aipc_2cpu_mb_enqueue( void *dp )
{
	...
	#ifdef MBOX_LOCK
	cyg_mutex_lock( &dsp_mb_mutex );
	ADEBUG(DBG_MBOX , "in mutex\n");
	#endif

	ASTATS.aipc_data_2cpu_send++;
...
static struct mbox_2dsp_send_priv       mbox_2dsp_send_dsc_2;
#endif
#ifdef CONFIG_RTL8686_IPC_TEST_THREAD_3	
static struct task_struct *             mbox_2dsp_send_task_3=NULL;
static struct mbox_2dsp_send_priv       mbox_2dsp_send_dsc_3;
#endif


#ifdef CPU_DATA_TEST
static struct task_struct *             mbox_2dsp_send_task=NULL;
static struct mbox_2dsp_send_priv       mbox_2dsp_send_dsc;

static int 
mbox_2dsp_send_thread(void *p)
{
	struct mbox_2dsp_send_priv * tp = (struct mbox_2dsp_send_priv *)p;
