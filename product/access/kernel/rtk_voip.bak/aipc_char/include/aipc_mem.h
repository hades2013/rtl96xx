...
#define AIPC_CPU_IPC_SRAM_ADDR	0xbfc00000	//virtual address. need to transfer to physical address
#define AIPC_DSP_IPC_SRAM_ADDR	0xbfc00000
...
#ifdef CONFIG_RTL8686_DRAM_64_MB
#define AIPC_DRAM_SIZE			0x4000000 	//64MB
#elif defined(CONFIG_RTL8686_DRAM_32_MB)
#define AIPC_DRAM_SIZE			0x2000000 	//32MB
#else
#error "need to check DRAM size"
#endif
