...
// 6318
#define REG_8685_PINMUX_SPI_PCM		(0xB800010C)
#define BIT_VOIP_SPI_DIR_256_PIN	BIT(16)
#define BIT_VOIP_SPI_DIR_176_PIN	BIT(15)
//#define BIT_VOIP_SPI_DIR			BIT_VOIP_SPI_DIR_256_PIN
#define BIT_VOIP_SPI_DIR			BIT_VOIP_SPI_DIR_176_PIN
...
aipc_module_voip_set_pcm_fs(void)
{
	if (SOC_ID != 0x0371) {
		// 6318
		if (SOC_ID == 0x0561) {
			SDEBUG( "REG_8685_PINMUX_SPI_PCM 0x%08x\n" , REG32(REG_8685_PINMUX_SPI_PCM) );
			REG32(REG_8685_PINMUX_SPI_PCM) |= BIT_VOIP_SPI_DIR;
			SDEBUG( "REG_8685_PINMUX_SPI_PCM 0x%08x\n" , REG32(REG_8685_PINMUX_SPI_PCM) );
		}
		// 6266
		else {
