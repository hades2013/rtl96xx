 ...
 * Set the Content-length header.
 * @param sip The element to work on.
 * @param content_length Integer value for the .
 */
...
/**
 * Allocate and Add a new History-Info header.
 * @param sip The element to work on.
 * @param value the value of the new header.
 */
#define osip_message_set_history_info(sip,value)     osip_message_set_header((osip_message_t *)sip,(const char *)"Hostory-Info",value)
/**
 * Find a History-Info header.
 * @param sip The element to work on.
 * @param pos The index of the header in the list of unknown header.
 * @param dest A pointer on the element found.
 */
#define osip_message_get_history_info(sip,pos,dest)   osip_message_header_get_byname(( osip_message_t *)sip,(const char *)"history-info",pos,(osip_header_t **)dest)

/**
 * Allocate and Add a new Diversion header.
 * @param sip The element to work on.
 * @param value the value of the new header.
 */
#define osip_message_set_diversion(sip,value)     osip_message_set_header((osip_message_t *)sip,(const char *)"Diversion",value)
/**
 * Find aDiversion header.
 * @param sip The element to work on.
 * @param pos The index of the header in the list of unknown header.
 * @param dest A pointer on the element found.
 */
#define osip_message_get_diversion(sip,pos,dest)   osip_message_header_get_byname(( osip_message_t *)sip,(const char *)"diversion",pos,(osip_header_t **)dest)
