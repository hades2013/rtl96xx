...
//******* VoiceService.{i}.VoiceProfile.{i}.Line.{i}.X_CT-COM_IMS EntityLEAF*******
...
struct CWMP_PRMT tVPLineEntityObjectInfo[] =
{
    ...
    { "X_CT-COM_IMS",    eCWMP_tOBJECT,  CWMP_READ,  NULL}
};
...
struct CWMP_NODE tVPLineEntityObject[] =
{
    ...
    {&tVPLineEntityObjectInfo[eLineCodec],           NULL,                             tVPLineCodecEntityObject},
...
{
	/* VoiceService.{i}.VoiceProfile.{i}.Line.{i}.X_CT-COM_IMS. */
    int res = 0;
	unsigned int nVoiceProfileInstNum;
	unsigned int nSipLineInstNum;
	unsigned int nNumberOfLine;
