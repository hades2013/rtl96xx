...
//#endif
	...
	case MIB_VOICE_PROFILE__XCT_SERVER_TYPE:
		/* need check E8C , not support yet. */
		break;
    ...
    case MIB_VOICE_PROFILE__SIP__XCT_SESSIONUPDATETIMER:
    ...
    case MIB_PHYINTERFACE__TESTS__TESTSELECTOR:
		...
		if( pEvtMsg.e8c_autotest.TestSelector == 0){
			...
			strcpy( ( char * )pData, "X_CT-COM_SimulateTest");

		}
		break;
    case MIB_PHYINTERFACE__TESTS__PHONECONNECTIVITY:
		*( ( unsigned int * )pData ) = pEvtMsg.e8c_autotest.PhoneConnectivity;
		break;
...
//#endif
    ...
    case MIB_PHYINTERFACE__TESTS__TESTSELECTOR:
		...
		}else if (strcmp(( char * )pData ,"X_CT-COM_SimulateTest")==0){
...
#else
		return 1;	//1->self-reboot, 0->apply without reboot
#endif   
    }
	return 0;
}
				   ...
				   void *pData )
{
    ...
    /* VoiceService.1.PhyInterface.{ i }.X_ CT-COM_Stats.PoorQualityList.{ i }. */
