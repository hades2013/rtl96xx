 ...
 */
  typedef struct osip_negotiation_ctx
  {
 ...
 */
  typedef struct osip_negotiation
  {
 ...
 */
  ...
  int osip_negotiation_sdp_message_put_on_fax (sdp_message_t * sdp,int port);
...
int osip_negotiation_sdp_message_put_media_mode(sdp_message_t *sdp, int media_mode);
