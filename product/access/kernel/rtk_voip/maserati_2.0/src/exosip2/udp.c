...
#if 0
int rcm_eXosip_process_icmp_message( unsigned long ip, unsigned short port )
{
	eXosip_lock();

	rcm_osip_icmp_ict_execute(eXosip.j_osip, rcm_eXosip_get_ip_by_name, ip, port);
	rcm_osip_icmp_nict_execute(eXosip.j_osip, rcm_eXosip_get_ip_by_name, ip, port);
