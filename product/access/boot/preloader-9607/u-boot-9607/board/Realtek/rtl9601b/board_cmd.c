...
U_BOOT_CMD(
        ...
        "[command] [argument]\n"
        "  start [r|w|wr|rw] - start BTG for READ/WRITE/WRITE&READ/READ&WRITE test\n"
        "  stop              - stop all BTG operations\n"
        "  info              - show BTG parameters\n"
        "  result            - show BTG status\n"
        "  set <arg> <val>   - set val to arg\n"
