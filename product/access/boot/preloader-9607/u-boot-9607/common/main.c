...
extern int bootPwCheck(int flag);//add by dengjian
...
#else
    puts("\nPlease press ctrl+E to stop autoboot:");//modify by dengjian
    printf(" %d ", bootdelay);
#endif
...
# endif                
        ...
        if (10 > bootdelay)
        {
            puts("\b\b\b"); //modify by dengjian 2012-07-19 for u-boot ST
            printf (" %d ", bootdelay);
        }
        else
        {
            puts("\b\b\b\b"); //modify by dengjian 2012-07-19 for u-boot ST
            printf (" %d ", bootdelay);
        }
    }
...
/*begin add by shipeng 2013-03-21*/
    else
    {
