	...
	if (argc == 1) {	/*show list of commands */
        ...
        for (i = 0; i < cmd_items; i++) 
        {
            ...
            else
            {
                ...
                if ((0 == strcmp("?",cmd_array[i]->name))||(0 == strcmp("bdinfo",cmd_array[i]->name))||\
                   (0 == strcmp("flinfo",cmd_array[i]->name))||(0 == strcmp("help",cmd_array[i]->name))||\
                   (0 == strcmp("ping",cmd_array[i]->name))||(0 == strcmp("printenv",cmd_array[i]->name))||\
                   (0 == strcmp("reset",cmd_array[i]->name))||(0 == strcmp("saveenv",cmd_array[i]->name))||\
                   (0 == strcmp("setenv",cmd_array[i]->name))||(0 == strcmp("reset",cmd_array[i]->name)))
                {                
                    /* allow user abort */
                    if (ctrlc ())
                        return 1;
