...
static inline void *pblr_pmax(const void *a, const void *b) { return (void*)(((u32_t)(a)>(u32_t)(b))?(a):(b));}
static inline void *pblr_pmin(const void *a, const void *b) { return (void*)(((u32_t)(a)<(u32_t)(b))?(a):(b));}
#define pblr_max(a, b) (((a)>(b))?(a):(b))
#define pblr_min(a, b) (((a)<(b))?(a):(b))
