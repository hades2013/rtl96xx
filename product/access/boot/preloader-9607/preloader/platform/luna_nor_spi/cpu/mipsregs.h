...
#define read_32bit_register(source)                         \
({ int __res;                                                   \
	__asm__ __volatile__(                                   \
	".set\tpush\n\t"					\
	".set\treorder\n\t"					\
...
#define read_flash_unalign_word(addr)                         \
({ int __res;                                                   \
 	__asm__ __volatile__(                                   \
			".set\tpush\n\t"					\
			".set\treorder\n\t"					\
...
#define read_flash_unalign_hword(addr)                         \
({ int __res;                                                   \
 	__asm__ __volatile__(                                   \
			".set\tpush\n\t"					\
			".set\treorder\n\t"					\
...
#define read_32bit_cp0_register_select(source, i)                         \
({ int __res;                                                   \
	__asm__ __volatile__(                                   \
	".set\tpush\n\t"					\
	".set\treorder\n\t"					\
	"mfc0\t%0,"STR(source)", "STR(i)"\n\t"                            \
	".set\tpop"						\
	: "=r" (__res));                                        \
	__res;})

#define read_32bit_cp0_set_register(source)                    \
({ int __res;                                                   \
	__asm__ __volatile__(                                   \
	".set\tpush\n\t"					\
	".set\treorder\n\t"					\
...
#define write_32bit_cp0_register_select(register,i,value)                \
	__asm__ __volatile__(                                   \
	"mtc0\t%0,"STR(register)", "STR(i)"\n\t"				\
	"nop"							\
	: : "r" (value));

#define write_32bit_sp_register(value)                \
	__asm__ __volatile__(                                   \
	"move\t$29,%0\n\t"				\
	"nop"							\
	: : "r" (value));
