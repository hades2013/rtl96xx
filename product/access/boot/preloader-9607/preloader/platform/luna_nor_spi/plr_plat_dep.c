...
{
    /*OCD 60, ODT 50*/
    const unsigned int zq_force_value0 = 0x0022b49f;
    const unsigned int zq_force_value1 = 0x00570057;
    const unsigned int zq_force_value2 = 0x58282809;
    ...
    /* to set zq_pad_ctrl_reg0 ~ reg3 and reg6 ~ reg9. */
    for (i=0; i<4; i++) {
	    *(zq_pad_ctl_reg+i)   = zq_force_value0;
	    *(zq_pad_ctl_reg+i+6) = zq_force_value0;
    }
