...
#define MEMCTL_DRAM_WIDTH_FD_S (24)
#define MEMCTL_DRAM_WIDTH_MASK (0x3 << MEMCTL_DRAM_WIDTH_FD_S)

#define _memctl_debug_printf_E printf
//#define _memctl_debug_printf_E(...)
...
#define MEMCTL_DRAM_DDR3_MIN_BANK_NUM 	(8)
...
#define MEMCTL_DACSPCR_PERIOD_EN_FD_S	(31)
#define MEMCTL_DACSPCR_PERIOD_EN_MASK	(1 << MEMCTL_DACSPCR_PERIOD_EN_FD_S)
#define MEMCTL_DACSPCR_AC_SILEN_TRIG_FD_S	(20)
#define MEMCTL_DACSPCR_AC_SILEN_TRIG	(1 << MEMCTL_DACSPCR_AC_SILEN_TRIG_FD_S)
#define MEMCTL_DACSPCR_AC_SILEN_PERIOD_UNIT_FD_S (16)
#define MEMCTL_DACSPCR_AC_SILEN_PERIOD_UNIT_MASK (0xF << MEMCTL_DACSPCR_AC_SILEN_PERIOD_UNIT_FD_S)
#define MEMCTL_DACSPCR_AC_SILEN_PERIOD_FD_S      (8)
#define MEMCTL_DACSPCR_AC_SILEN_PERIOD_MASK      (0xFF << MEMCTL_DACSPCR_AC_SILEN_PERIOD_FD_S)
#define MEMCTL_DACSPCR_AC_SILEN_LEN_FD_S         (0)
#define MEMCTL_DACSPCR_AC_SILEN_LEN_MASK         (0xFF << MEMCTL_DACSPCR_AC_SILEN_LEN_FD_S)
...
#define MEMCTL_SOCPNR_0371		(0x83890000) /* 8686 */
#define MEMCTL_SOCPNR_0399		(0x03990000) /* 8390 Test chip */
#define MEMCTL_SOCPNR_6290		(0x62900000) /* 8390 Real chip */
#define MEMCTL_SOCPNR_6275		(0x62750000) /* 8380 Real chip */
#define MEMCTL_SOCPNR_6266		(0x62660000) /* 9600/8696 Real chip */
...
unsigned int memctls_init(void);
