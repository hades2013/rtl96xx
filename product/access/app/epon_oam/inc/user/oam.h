...
#define MAC_LEARNING_UNLIMIT 0X840
...
#if defined(CONFIG_PRODUCT_EM200) || defined(CONFIG_PRODUCT_EPN101R) || defined(CONFIG_PRODUCT_EPN101ZG)	
...
#define OAM_LOGIG_PON_PORT 		LOGIC_PON_PORT
...
struct oam_clasmark_local {
    oam_clasmark_rulebody_t ClsRule[8];
	oam_clasmark_fieldbody_t ClsField[8];
}__attribute__((packed));
typedef struct oam_clasmark_local oam_clasmark_local_t;
