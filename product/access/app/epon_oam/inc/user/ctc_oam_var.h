...
/*Port Mode*/
#define OAM_PORT_MODE_10H   0x1
#define OAM_PORT_MODE_10F   0x2
#define OAM_PORT_MODE_100H  0x3
...
extern int ctc_oam_varCb_dummy_set(
    ...
    ctc_varContainer_t *pVarContainer);  /* caller prepare all the resource needed, 
                                          ...
                                          */
extern int ctc_oam_varCb_alarmAdmin_set(
    unsigned char llidIdx, /* LLID index of the incoming operation */
    unsigned char op, /* Operation to be taken */
    ctc_varInstant_t *pVarInstant, /* It might be NULL if no instant specified */
    ctc_varDescriptor_t varDesc,
...
extern int ctc_oam_varCb_ponif_alarmThreshold_set(
    unsigned char llidIdx, /* LLID index of the incoming operation */
    unsigned char op, /* Operation to be taken */
    ctc_varInstant_t *pVarInstant, /* It might be NULL if no instant specified */
    ctc_varDescriptor_t varDesc,
...
extern int ctc_oam_varCb_ethPortDsPolicing_get(
	unsigned char llidIdx, /* LLID index of the incoming operation */
	unsigned char op, /* Operation to be taken */
	ctc_varInstant_t *pVarInstant, /* It might be NULL if no instant specified */
	ctc_varDescriptor_t varDesc,
...
/* 0xC7/0x0016 - ethPortDs Policing */
extern int ctc_oam_varCb_ethPortDsPolicing_set(
	unsigned char llidIdx, /* LLID index of the incoming operation */
	unsigned char op, /* Operation to be taken */
	ctc_varInstant_t *pVarInstant, /* It might be NULL if no instant specified */
	ctc_varDescriptor_t varDesc,
...
extern int ctc_oam_varCb_calssificationMarking_get(
	unsigned char llidIdx, /* LLID index of the incoming operation */
	unsigned char op, /* Operation to be taken */
	ctc_varInstant_t *pVarInstant, /* It might be NULL if no instant specified */
	ctc_varDescriptor_t varDesc,
...
/* 0xC7/0x001d - EthPortMode */
extern int ctc_oam_varCb_ethPortmode_set(
    unsigned char llidIdx, /* LLID index of the incoming operation */
    unsigned char op, /* Operation to be taken */
    ctc_varInstant_t *pVarInstant, /* It might be NULL if no instant specified */
    ctc_varDescriptor_t varDesc,
...
extern int ctc_oam_varCb_ethPortStatistic_get(
unsigned char llidIdx, /* LLID index of the incoming operation */
unsigned char op, /* Operation to be taken */
ctc_varInstant_t *pVarInstant, /* It might be NULL if no instant specified */
ctc_varDescriptor_t varDesc,
